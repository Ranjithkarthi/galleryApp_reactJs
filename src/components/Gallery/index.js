...
class Gallery extends Component {
  ...
  clickThumbnail = id => {
    this.setState({activeThumbnailId: imagesList[id].id, isActive: true})
  }

  render() {
    const {activeThumbnailId, isActive} = this.state
    ...
    return (
      <div className="bg-container">
        ...
        <p className="desc">Nature Photography by Ranjith</p>
